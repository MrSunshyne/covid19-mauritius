        ...
        <div class="share">
          ...
          <a
            ...
            >
              ...
              <use xlink:href="#pinterest" fill="CurrentColor"></use></svg
          ></a>
          <a
            class="button"
            target="_blank"
            ...
            >
              ...
              <use xlink:href="#linkedin" fill="CurrentColor"></use></svg
          ></a>
          <a
            class="button"
            target="_blank"
            ...
            >
              <title>tumblr</title>
              <use xlink:href="#tumblr" fill="CurrentColor"></use></svg
          ></a>
          <a
            class="button"
            target="_blank"
            ...
            >
              <title>reddit</title>
              <use xlink:href="#reddit" fill="CurrentColor"></use></svg
          ></a>
          ...
          <a
            ...
            >
              ...
              <use xlink:href="#hackernews" fill="CurrentColor"></use>
            </svg>
          </a>
          ...
          <a
            ...
            >
              ...
              <use xlink:href="#designernews" fill="CurrentColor"></use>
            </svg>
          </a>
          ...
          <a
            ...
            >
              <title>email</title>
              <use xlink:href="#email" fill="CurrentColor"></use>
            </svg>
          </a>
        </div>
      </div>
