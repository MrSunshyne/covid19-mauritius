<template>
  <div class="py-8 px-8 md:px-0 bg-gray-900">
    <div class="flex flex-col" v-if="getTimeseries">
      <div
      ...
      <div class="md:flex justify-center text-white items-center p-4 md:py-0">
        ...
        <div class="py-4 mx-10 md:pb-8 text-center">
          <h2
            ...
            v-if="getTimeseries"
          >
            <span class="text-gray-600">COVID-19 in</span>
            {{ currentCountry }}
          </h2>
        </div>
...
export default {
  ...
  head() {
    return {
      title:
        `${this.currentCountry} COVID-19 Statistics` ||
        'COVID-19 Mauritius Statistics | Explore Interactive COVID-19 Data',
      meta: [
        {
          hid: 'og:image',
          name: 'og:image',
          content: 'https://covid19.ramgolam.com/og-image.jpg'
        },
        {
          hid: 'description',
          name: 'description',
          content:
            `Statistics on the cases of COVID 19 in ${this.currentCountry}. Find updated information about the latest numbers of coronavirus in ${this.currentCountry} and around the world` ||
            'Statistics on the cases of COVID 19 in Mauritius. Find updated information about the latest numbers of coronavirus in Mauritius and around the world'
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content:
            `covid19, ${this.currentCountry}, numbers, graph, coronavirus ${this.currentCountry}` ||
            'covid19, mauritius, numbers, graph, coronavirus mauritius, ile maurice'
        }
      ]
    }
  }
